...
[![Last Commit](https://img.shields.io/github/last-commit/glauth/glauth.svg)](https://github.com/osirium/glauth/graphs/commit-activity)
...
1. Download a precompiled binary from the [releases](https://github.com/osirium/glauth/releases) page.
2. Download the [example config file](https://github.com/osirium/glauth/blob/master/sample-simple.cfg).
...
More configuration options are documented here: https://github.com/osirium/glauth/blob/master/sample-simple.cfg
